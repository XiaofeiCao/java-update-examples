...
package com.azure.messaging.eventhubs.checkpointstore.inmemory;
 ...
 * 
 * <p>Based on SampleCheckpointStore from Azure SDK samples.</p>
 */
public class InMemoryCheckpointStore implements CheckpointStore {
    ...
    public Flux<PartitionOwnership> claimOwnership(List<PartitionOwnership> requestedPartitionOwnerships) {
        ...
        return Flux.fromIterable(requestedPartitionOwnerships)
                ...
                .doOnNext(partitionOwnership ->
                        LOGGER.atInfo()
                                .addKeyValue("partitionId", partitionOwnership.getPartitionId())
    ...
    public Mono<Void> updateCheckpoint(Checkpoint checkpoint) {
        ...
        LOGGER.atInfo()
                .addKeyValue("partitionId", checkpoint.getPartitionId())
                .addKeyValue("sequenceNumber", checkpoint.getSequenceNumber())
